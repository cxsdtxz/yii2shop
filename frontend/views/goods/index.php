                            ...
                            <?php foreach ($twos as $two):?>
                                <dl class="dl_1st">
                                    ...
                                    <?php foreach ($threes as $three):?>
                                        <dd>
                                            <a href="<?=\yii\helpers\Url::to(['list/index','goods_category_id'=>$three->id])?>"><?=$three->name?></a>
                                        </dd>
                                    <?php endforeach;?>
                                </dl>
                            <?php endforeach;?>
...
<!--                            </li>-->
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li class="star"><span>点击量：</span> <a href=""><?=$goods->view_times?></a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>
                <form action="<?=\yii\helpers\Url::to(['goods/add-carts'])?>" method="get" class="choose">
                    <ul>
