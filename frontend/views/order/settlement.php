...
<div style="clear:both;"></div>
<form action="<?=\yii\helpers\Url::to(['order/save-order'])?>" method="post">
<!-- 主体部分 start -->
        ...
        <div class="address">
            ...
            <div class="address_info">
                <p>
                    ...
                    <input type="radio" value="<?=$address->id?>" name="address_id" <?= $address->default?"checked":""?>/>
                        <?=$address->name?>&emsp;
                        <?=$address->tel?>&emsp;
                        <?=$address->city?>&emsp;
                        <?=$address->county?>&emsp;
        ...
        <div class="delivery">
            ...
            <div class="delivery_select">
                <table>
                    ...
                    <tr class="cur">
                        <td>
                            <input type="radio" name="delivery" value="<?=$delivery->delivery_id?>" <?=$delivery->delivery_id==1?'checked':''?> /><?=$delivery->delivery_name?>
                        </td>
        ...
        <div class="pay">
            ...
            <div class="pay_select">
                <table>
                    ...
                    <tr class="cur">
                        <td class="col1"><input type="radio" name="pay" value="<?=$payment->payment_id?>" <?= $payment->payment_id == 2?"checked":""?>/><?=$payment->payment_name?></td>
        ...
        <div class="goods">
            ...
            <table>
                ...
                <tr>
                    ...
                    <?php $num += 1; $total += $cart->amount*$goods->shop_price?>
                <?php endforeach;?>
                </tbody>
                <tfoot>
                <tr>
